...
-- DROP TABLE CHI_TIET_DON_DAT_HANG
...
) ON PScheme_NgayLap(NgayLapDDH);
GO
CREATE CLUSTERED INDEX CI_DON_DAT_HANG_NgayLap ON DON_DAT_HANG(NgayLapDDH) ON PScheme_NgayLap(NgayLapDDH)
GO
